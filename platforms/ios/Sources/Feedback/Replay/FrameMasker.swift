...
enum FrameMasker {
    ...
    /// `markerioPrivateViews`, to exclude a view. Mirrors `data-private` on web
    /// and the `markerio-private` tag on Android.
    static let privateIdentifier = "markerio-private"

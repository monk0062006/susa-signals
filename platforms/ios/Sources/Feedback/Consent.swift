...
public final class ConsentManager {
    private enum Key {
        static let scopes = "markerio.consent.scopes"
        static let version = "markerio.consent.version"
        static let grantedAt = "markerio.consent.grantedAt"
        static let source = "markerio.consent.source"
    }

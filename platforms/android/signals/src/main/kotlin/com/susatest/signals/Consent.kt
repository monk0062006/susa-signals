...
class ConsentManager(
    ...
    private companion object {
        const val KEY_SCOPES = "susa.signals.consent.scopes"
        const val KEY_VERSION = "susa.signals.consent.version"
        const val KEY_GRANTED_AT = "susa.signals.consent.grantedAt"
        const val KEY_SOURCE = "susa.signals.consent.source"
    }

package com.susatest.signals.survey
 ...
 */
fun toAnswer(questionId: String, value: Any?): com.susatest.signals.Answer = when (value) {
    is List<*> -> com.susatest.signals.Answer(
        questionId = questionId,
        values = value.map { it.toString() }
    )
    null -> com.susatest.signals.Answer(questionId = questionId, value = "")
    else -> com.susatest.signals.Answer(questionId = questionId, value = value.toString())
}

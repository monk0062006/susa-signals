...
import com.susatest.signals.annotate.FeedbackOverlay
import com.susatest.signals.replay.FrameRecorder
import com.susatest.signals.survey.Study
import com.susatest.signals.survey.SurveyPanel
import com.susatest.signals.replay.HttpFrameUploader
...
private const val TAG = "SusaSignals"
...
class FeedbackSdk private constructor(
    ...
    private val worker: ExecutorService = Executors.newSingleThreadExecutor { runnable ->
        Thread(runnable, "susa-signals").apply { isDaemon = true }
    }

package io.markerusa.feedback.replay
...
import io.markerusa.feedback.ConsentManager
import io.markerusa.feedback.ConsentScope
...
class FrameRecorder(
    ...
    fun start(activity: Activity): String? {
        ...
        val handlerThread = HandlerThread("markerio-replay").apply { start() }
